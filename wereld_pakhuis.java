...
public class wereld_pakhuis extends World {
    ...
    private String currentname = "pakhuis"; // zet dit naar de naam van de wereld voor makkelijkere veranderen naar een nieuwe wereld

//--------------------------------------------------------------------------------------------------------------------//
//--------------------------------------------------------------------------------------------------------------------//

    public wereld_pakhuis() {
