...
/**
 * Write a description of class achtergrond_industrie here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class achtergrond_industrie extends Achtergronden
{
    private int lastPlayerX = Integer.MIN_VALUE;
    /**
     * Act - do whatever the achtergrond_industrie wants to do. This method is called whenever
    ...
    public void act()
    {
        ...
        if (lastPlayerX == Integer.MIN_VALUE) { //als lastPlayerX nog niet is ingesteld, stel het in op de huidige x-positie van de speler en stop met acteren
            lastPlayerX = px;   // Update lastPlayerX to the current x position of the player for the next act cycle
            return;
        }
